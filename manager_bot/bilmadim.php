...
$admin = 736482067;
define('API_KEY', '6697864263:AAEvbrkiDZk9ObTG07juE1NHDYfbnom6O4M');
...
// if($message->new_chat_member || $message->left_chat_member){ // bu yangi qo'shilgan foydalanuvchilarni kirganligi to'g'risidagi malumotni o'chirib beradigan kod 
...
// if($chat_id == 736482067)
{
    ...
    //     ]);
    // }
    // else if($caption == "#addfile" || $document || $photo || $audio || $video){ // bunda tekshiryabmiz 
    //     if($document){
    ...
    //         $type = "audio";
    //     }else if($photo){
    //         $file = array_pop($photo)->file_id; // photo sal boshqacharoq sababi photo 3 xil farmatda keladi biz uni eng oxidagisini olsak sifati eng yaxshi bo'ladi 
    //         $method = "sendPhoto";
    //         $type = "photo";
    //     };
    // if ($method) {
...
//     if(count($new_members) > 0 && $new_members[0]->id != $from_id){ //  top natijalarni olish 
...
//             'reply_markup' => json_encode([
//                 'inline_keyboard' => get_fallows(['test_btn' => true]) // false edi o'zi
//             ])
//         ]);
//     }
// };

// // /mycloud+3+ File haqida !!!
